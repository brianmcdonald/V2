...
<!--	<script src="<?php bloginfo('stylesheet_directory'); ?>/bootstrap/js/carousel.js"></script> -->
<?php
		...
		<div class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<img src="http://projectmonma.org/wp-content/uploads/logo.png" style= "height: 50px;">
				</span>
