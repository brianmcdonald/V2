...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><?php next_posts_link( __( '<b><span class="glyphicon glyphicon-chevron-left btn-xs"></span> Older posts</b>', 'twentyten' ) ); ?></div>
					<div class="nav-next"><?php previous_posts_link( __( '<b>Newer posts <span class="glyphicon glyphicon-chevron-right btn-xs"></span></b>', 'twentyten' ) ); ?></div>
				</div><!-- #nav-below -->
<?php endif; ?>
